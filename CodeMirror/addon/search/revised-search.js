...
((mod) => {
  ...
  var replaceDialog = `
    <div class="find">
      ...
      <input id="CodeMirror-find-field" type="text" class="CodeMirror-search-field" />
      <span class="CodeMirror-search-hint"></span>
    </div>
    <div class="replace">
      <label for="CodeMirror-replace-field">With:</label>
      <input id="CodeMirror-replace-field" type="text" class="CodeMirror-search-field"/>
    </div>
    <div class="buttons">
     <button class="btn btn-info btn-sm">Previous</button>
	<button class="btn btn-info btn-sm">Next</button>
	<button class="btn btn-info btn-sm">Replace</button>
	<button class="btn btn-info btn-sm">Replace All</button>
  ...
  var findDialog = `
    <div class="find">
    <label for="CodeMirror-find-field">Search:</label>
     <input id="CodeMirror-find-field"  style="width: 55em" type="text" class="CodeMirror-search-field"/>
      <span class="CodeMirror-search-hint"></span>
    </div>
    <div class="buttons">
	<button class="btn btn-info btn-sm">Previous</button>
  ...
  let updateCount = (cm) => {
    ...
    let countText = count === 1 ? '1  found.' : count + '  found.';
